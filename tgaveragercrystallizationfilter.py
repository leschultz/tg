...
df = pd.read_pickle('Tg_and_crystallization.pkl')
...
dfavg.to_html('Tg_and_crystallization_averages.html')  # Export as an HTML table
dfavg.to_pickle('Tg_and_crystallization_averages.pkl')  # Export as a pickle file
